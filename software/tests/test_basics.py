...
#        example_count = example_count + len(t)
    ...
    self.assertTrue(example_count > 0 and example_count < 600, "Expect that we extracted 200 < x < 600 examples from data/*examples.txt. Found: %s " % example_count)
